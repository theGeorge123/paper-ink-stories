...
export default function Auth() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Note: setGoogleLoading(false) not called on success because user will be redirected
  };
      ...
      >
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p id="password-requirements" className="text-xs text-muted-foreground pl-1">
